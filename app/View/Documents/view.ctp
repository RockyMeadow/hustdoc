...
<div class="related row">
	<div class="col-md-12">
		...
		<?php if (!empty($document['Comment'])): ?>
			<div class="row">
			<div class="col-md-8">
				<?php $this->Html->css('comment', null, array('inline' => false)); ?>
								...
								<article class="row">
									<div class="col-md-10 col-sm-10">
										<div class="panel panel-default arrow left">
											<div class="panel-body">
												<header class="text-left" style="margin-bottom : 10px; border-bottom: 1px dotted #ccc;">
													<div class="comment-user"><i class="fa fa-user"></i><?php echo $this->Html->link($comment['username'], array('controller' => 'users', 'action' => 'view', $comment['user_id'])); ?></div>
													<time class="comment-date" datetime="16-12-2014 01:05"><i class="fa fa-clock-o"></i><?php echo $comment['created']; ?></time>
												</header>
				...
				<div class="row">
					...
					<div class="form-group">
						<?php echo $this->Form->hidden('document_id', array('value'=> $document['Document']['id'])); ?>
						<div class="col-lg-12">
							<div class="col-lg-10">
								<textarea class="form-control" rows="3" name="data[Comment][content]" id="CommentContent" placeholder='What do you have in mind ?'></textarea>
							</div>
							<div class="col-lg-offset-10 submit">
